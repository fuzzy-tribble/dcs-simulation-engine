"""Gradio Widget GUI simulation engine.

Exposes a minimal Gradio-based interface for loading a simulation YAML,
selecting characters and graph configuration, running chat-like turns,
and exporting a transcript.
